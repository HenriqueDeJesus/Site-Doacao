    ...
    <!-- Início do formulário -->
        ...
        <div class="card">
            <div class="card-top">
                ...
                <h2 class="title">Realizar Doação</h2>
            </div>
        ...
        <a href="https://heryherrnandes.000webhostapp.com/Doacao/funcionario/sistema.php" class="retornar">Cancelar</a>   
        </div>
    </div>
     </form>           
...
function myFunction() {
  alert("Item reservado com sucesso");
    ...
    <script type="text/javascript" src="java/personalizadoDoa.js"></script>
    <script type="text/javascript" src="java/personalizadoItemD.js"></script>
</body>
</html>